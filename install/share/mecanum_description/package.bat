...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\mecanum_description\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/mecanum_description/local_setup.bat"
