...
set "AMENT_ENVIRONMENT_HOOKS[mecanum_description]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mecanum_description] "%AMENT_CURRENT_PREFIX%\share\mecanum_description\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[mecanum_description] "%AMENT_CURRENT_PREFIX%\share\mecanum_description\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[mecanum_description]:;=";"%") do (
    call:call_file %%f
  )
